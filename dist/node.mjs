 ...
 * @modify date 2020-08-14 20:19:49
 */
import { cpus } from 'os';
...
function node (data) {
  var threads = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : cpus().length;
  return new WebWorker(data, threads, Worker$1, true);
}
